...
<form class="form-horizontal" role="form" method="post" action="envioPOST/nuevaImagenuser.php" name="formularioUPimage" enctype="multipart/form-data">
	...
	<div class="form-group">
		<button  type="reset" class="btn btn-danger btnforms"><span class=""></span>Cancelar</button>
		<button  type="submit" class="btn btn-success btnforms" ><span class="fa fa-upload"></span>Subir</button>
	</div>
</form>